...
Page({
   ...
   */
  data: {
    title: '九零后女生最爱的香水味道类型不知道你喜欢哪一类型的',
    problem: '探寻自己的“自由个性”，并有意识地锻炼它，将有助于个人事业的开展。我们完全可以在做自己的同时，选择性地“不去做自己”',
    options: {
      type: 'font',
      list: [
        {
  ...
  next(e) {
    ...
    self.data.options.list.forEach((option, index) => {
      if (index === e.detail.index) {
        ...
        // app.globalData.results.splice(1, length - 1, one)
